...
#undef RIGHT
	...
	{
		UpdatePaths(screen, blocks, bSize); // SprÛbuj optymalizowaÊ ograniczeniem odleg≥oúci
		
		DrawFoodMap(screen, paths, bSize); // SprÛbuj optymalizowaÊ ograniczeniem odleg≥oúci
